...
#### "Un grupo consiste en dos o más personas que comparten metas comunes, tienen una relación estable, son en cierto sentido interdependientes y percioben que en realidad forman parte de un grupo"(Paulus,1989)
...
#### 1. Las personas se sienten en un grupo en la media que experimenten los mismos resultados
#### 2. Sin estructura y roles sólo sería un puñado de individuos
#### 3. _Entitatividad_ de un grupo
...
* Individuos se adaptan a los grupos existentes en el entorno
...
```{r, out.width="50%", fig.align='center'}
knitr::include_graphics("clase1_files/SV_38ZKWABGubwU9Bs-qrcode.png")
```
